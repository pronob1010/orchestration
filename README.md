...
workspace-issues/
  issue-2981/
    auth-service/     ← isolated branch, full working copy
    payment-service/  ← isolated branch, full working copy
    dokan-cloud/      ← isolated branch, full working copy
```

No stashing. No branch juggling. No context switching between tasks. When the PR is merged, one click removes all the worktrees and branches.

Built for teams that ship fast across many services and increasingly rely on AI agents to do the implementation work.
